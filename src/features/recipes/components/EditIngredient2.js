...
function EditIngredient(props) {
  ...
  return (
    <div 
        ...
        className="flex items-start gap-2 sm:items-center sm:gap-4 pb-6 mb-6 border-b border-slate-100 last:border-0 last:mb-0 last:pb-0 min-w-0"
    >
        {/* 1. Input Stack (Left Side) - pt-2 ensures the first row labels have room */}
        <div className="min-w-0 flex-1 flex flex-col gap-4 pt-2">
            ...
            <div className="w-full min-w-0 relative">
                ...
                <input 
                    ...
                    className="w-full min-w-0 bg-[#f8fafc] rounded-xl px-4 py-3 text-base font-bold border outline-none transition-all focus:border-brand focus:ring-4 focus:ring-blue-500/10 focus:bg-white"
            ...
            <div className="w-full min-w-0 relative">
                ...
                <div className="flex gap-2 min-w-0">
                    ...
                    <button
                        ...
                        className="shrink-0 w-12 sm:w-14 h-[50px] flex items-center justify-center rounded-xl border border-[#0071dc]/20 bg-[#0071dc]/5 text-[#0071dc] hover:bg-[#0071dc]/10 disabled:opacity-40 disabled:cursor-not-allowed transition-all active:scale-95"
                    >
